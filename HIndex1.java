...
//idea is to sort the array and first check median value weather it is hindex or not means to check weather no of paper after median are equal to median value or not.
